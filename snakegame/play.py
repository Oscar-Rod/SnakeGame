...
def run(resolution, speed, show_screen, human_player, training, number_of_snakes_to_save, snake_initial_size, number_of_cells,
        number_of_generations, number_of_snakes, mutation_rate, perception):
    game_motor = Motor(resolution, speed, show_screen=show_screen, human_player=human_player, training=training,
